...
<h2 style="color:#525358; font-size:20px; margin-top:0; margin-bottom:24px;">Neue Nachricht über das VINLIGNA Kontaktformular</h2>
...
<p style="font-size:12px; color:#525358; margin-top:40px; text-align:right;">Zeitstempel: ${timestamp}</p>
</div>
<div style="background-color:#FFFFFF; text-align:center; padding:16px; font-size:12px; color:#525358; border-top:1px solid #eeeeee;">VINLIGNA | Hochwertige Fassmöbel aus recycelten Weinfässern</div>
</div>
</body>
</html>`;
}
...
<div style="padding:32px;">
<h2 style="color:#525358; font-size:20px; margin-top:0; margin-bottom:24px;">Vielen Dank für Ihre Nachricht</h2>
<p style="font-size:16px; margin-bottom:24px; color:#525358;">Lieber ${data.name},<br><br>vielen Dank für Ihre Anfrage über unser Kontaktformular.<br>Wir werden uns so schnell wie möglich bei Ihnen melden.</p>
<h3 style="color:#525358; margin-top:24px; margin-bottom:8px;">Ihre Nachricht:</h3>
<div style="background-color:#F9F6F3; padding:16px; border-left:4px solid #D96B37; margin-top:8px; word-wrap:break-word; overflow-wrap:anywhere; white-space:normal; max-width:100%;">
${formattedMessage}
</div>
<p style="font-size:14px; margin-top:32px; color:#525358;">Mit herzlichen Grüßen,<br>Ihr VINLIGNA Team</p>
<hr style="border:none; border-top:1px solid #ddd; margin:32px 0;" />
<div>
<p style="font-size:14px; color:#525358;"><strong>VINLIGNA</strong><br>E-Mail: <a href="mailto:info@vinligna.com" style="color:#D96B37; word-break:break-word;">info@vinligna.com</a><br>Web: <a href="https://www.vinligna.com" style="color:#D96B37; word-break:break-word;">www.vinligna.com</a></p>
</div>
</div>
<div style="background-color:#FFFFFF; text-align:center; padding:16px; font-size:12px; color:#525358; border-top:1px solid #eeeeee;">Hochwertige Fassmöbel aus recycelten Weinfässern</div>
</div>
</body>
</html>`;
}
