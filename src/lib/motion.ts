...
// Common Framer Motion variants and animation settings
// These can be imported and used across all pages for consistent animations
...
// Default animation settings for consistent use
