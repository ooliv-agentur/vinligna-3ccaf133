...
export const ProductCard = ({ icon, title, description, image }: ProductCardProps) => (
  <div className="flex flex-col h-full hover-scale">
    ...
    <div className="flex-1 p-6 bg-black/10 dark:bg-white/5 backdrop-blur-sm rounded-b-lg border border-t-0 border-white/10">
      ...
      <p className="text-foreground/80 dark:text-white/70 text-sm">{description}</p>
    </div>
  </div>
);
